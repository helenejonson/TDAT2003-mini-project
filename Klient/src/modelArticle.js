            ...
            <div>
                <div className='preview'>
                    ...
                    <div className='rating'>
                        <p>Rating</p>
                        <button type="button" className="btn btn-success like" >Like</button>
                        <button type="button" className="btn btn-danger dislike">Dislike</button>
                        <p>Likes: {this.props.art.likes} Dislikes: {this.props.art.dislikes}</p>
