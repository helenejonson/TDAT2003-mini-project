...
export class Comments extends Component<{ id: number } > {
    ...
    comment: Comment = new Comment(
        1, this.props.id, 'myUsername', 'myText',new Date()
    );
    comments: Comment[] = [];
            ...
            <div>
                ...
                <div className="collapse" id="collapseExample">
                    ...
                    <div className="form-group">
                        ...
                        <textarea className="form-control" id="inputComment" placeholder='Comment...' rows="3"
                                  onChange={(event: SyntheticInputEvent<HTMLInputElement>) => (this.comment.text = event.target.value)}></textarea>
                    </div>
                    <button type="button" className="btn btn-primary" onClick={this.commentUpload}>Publish</button>
                </div>
    ...
    commentUpload(){
        ...
        databaseService.addComment(this.comment).then(d =>
