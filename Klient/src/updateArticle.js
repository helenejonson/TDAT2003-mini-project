...
export class UpdateArticle extends Component<{ match: { params: { id: number } } }> {
              ...
              <form>
                ...
                <div className="form-group">
                  <div className="row">
                    ...
                    <div className="col-sm-8">
                      <input id="title" className="form-control form-control-lg" type="text" aria-describedby="titleHelp" value={this.article.title}
                ...
                <div className="form-group">
                  ...
                  <div className="row">
                    ...
                    <div className="col-11">
                      <input id="imgPath" className="form-control"
                             type="text" value={this.article.picturePath}
                  ...
                  <div className="row">
                    ...
                    <div className="col-11">
                      <input id="imgAlt" className="form-control" type="text" value={this.article.pictureAlt} aria-describedby="imgAltHelp"
                  ...
                  <div className="row">
                    ...
                    <div className="col-11">
                      <input id="imgCapt" className="form-control"
                             type="text" value={this.article.pictureCapt}
                ...
                {/*====== markdown text ======*/}
                <div className="form-group">
                  <SimpleMDE onChange={this.handleMarkdownChange} label="Main text" value={this.article.text} options={{spellChecker: false}} />
                </div>
                {/*author*/}
                <div className="row">
                  ...
                  <div className="col-11">
                    <input id="author" className="form-control"
                           type="text" value={this.article.author}
  ...
  handleUpdate(){
    ...
    databaseService.updateArticle(this.article)
